    ...
    public partial class Form1 : Form
    {
        ...
        private void calculateWinnings()
        {
            if (pictureBox1.Image == seven && pictureBox2.Image == seven && pictureBox3.Image == seven)
            {
                ...
                MessageBox.Show("You have dropped a jackpot, Congrats!");

            }
            else if (pictureBox1.Image == seven && pictureBox2.Image == pineapple && pictureBox3.Image == pineapple)
                {
            ...
            else if (pictureBox1.Image == grape && pictureBox2.Image == seven && pictureBox3.Image == pineapple)
            {
                currentBalanceLabel = currentBalanceLabel + 10;
                textBox2.Text = Convert.ToString(currentBalanceLabel);
                spinWinningsLabel = 10;
            ...
            else if (pictureBox1.Image == lemon && pictureBox2.Image == lemon && pictureBox3.Image == grape)
            {
                currentBalanceLabel = currentBalanceLabel + 10;
                textBox2.Text = Convert.ToString(currentBalanceLabel);
                spinWinningsLabel = 10;
            ...
            else if (pictureBox1.Image == seven && pictureBox2.Image == lemon && pictureBox3.Image == grape)
            {
                currentBalanceLabel = currentBalanceLabel + 10;
                textBox2.Text = Convert.ToString(currentBalanceLabel);
                spinWinningsLabel = 10;
            ...
            else if (pictureBox1.Image == seven && pictureBox2.Image == lemon && pictureBox3.Image == seven)
            {
                currentBalanceLabel = currentBalanceLabel + 10;
                textBox2.Text = Convert.ToString(currentBalanceLabel);
                spinWinningsLabel = 10;
